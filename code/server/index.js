...
mongoose.connect('mongodb://localhost:27017/Freelancing',{
    ...
    try {
        ...
        if (!client || !freelancer || !project || !freelancerData) {
            return res.status(404).json({ 
                error: "Required data not found. Check if IDs for Client, Freelancer, and Project are correct." 
            });
        }
        ...
        const newApplication = new Application({
            projectId,
            clientId,
            clientName: client.username, // Now safe to read
